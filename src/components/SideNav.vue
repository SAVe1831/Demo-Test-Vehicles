<template>
    <div class="side-nav-container relative">
        <p class="side-nav-container-title">Demo Test</p>
        <div class="menu w-full flex flex-column">
                <div class="nav-item" :class="isLinkActive('/profile')">
                    <router-link to="/profile">
                        <div class="nav-item-icon-text flex align-items-center mx-auto">
                ...
                <div class="nav-item" :class="isLinkActive('/vechicles')">
                    <router-link to="/vechicles">
                        <div class="nav-item-icon-text flex align-items-center mx-auto">
                            <div class="nav-item-icon">
                                <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p class="nav-item-text">Vechicles</p>
                        </div>
                    </router-link>   
                </div>    
                <div class="nav-item" :class="isLinkActive('/setting')">
        ...
        <div class="wave absolute bottom-0">
